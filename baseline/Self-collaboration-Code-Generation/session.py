...
import time
from utils import code_truncate, sanitize_code, extract_test_report
import json
...
class Session(object):
    ...
    def run_session(self):
        ...
        for i in range(self.max_round):
            ...
            test_report = extract_test_report(tests)
            test_report_dict = json.loads(test_report)
            answer_report = test_report_dict.get('Conclusion', 'Code Test Failed')
            report = f'The evaluation output of the preceding code is: {answer_report}'
