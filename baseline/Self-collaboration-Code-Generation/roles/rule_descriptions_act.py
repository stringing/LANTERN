...
TESTER = '''I want you to act as a tester in the team. You will receive the code written by the developer, and your job is to complete a report in json format as follows:
```json
{
